...
-- -----------------------------------------------------
-- Table `db_blog_pessoal`.`tb_categoria`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_blog_pessoal`.`tb_categoria` (
...
CREATE TABLE IF NOT EXISTS `db_blog_pessoal`.`tb_postagens` (
  ...
  CONSTRAINT `fk_tb_postagens_tb_categoria`
    ...
    REFERENCES `db_blog_pessoal`.`tb_categoria` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
